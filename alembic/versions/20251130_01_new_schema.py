...
def upgrade() -> None:
    ...
    op.create_table(
        "workout_metadata",
        sa.Column("workout_id", sa.Integer(), sa.ForeignKey("workouts.id", ondelete="CASCADE"), primary_key=True),
        sa.Column("volume_total", sa.String(length=50), nullable=True),
        sa.Column("work_rest_ratio", sa.String(length=20), nullable=True),
        sa.Column("dominant_stimulus", sa.String(length=50), nullable=True),
        ...
        sa.Column("session_load", sa.String(length=20), nullable=True),
